...
def drawSubnetBar(filename, cookie):
    ...
    subnetBar.setLabel(xLabel="subnet ID", yLabel="Count of involved IPs")
    subnetBar.setLim("y", [0, 256])
    subnetBar.doPaint(cookie)


if __name__ == '__main__':
    date = "2018-03-07"
    filename = "../../result/SubnetCount/%s/appeared/inbound/inSubnet_2018-03-07_00.log" % date
    drawSubnetBar(filename, "inbound")
